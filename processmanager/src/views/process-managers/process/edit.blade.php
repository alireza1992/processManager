...
@section(config('process-manager.views.content'))
    <div class="container product">
        ...
        {!! Form::model($admin,['route'=>[config('process-manager.auth' . 'process-managers.route').'process.update',$admin->id],'method'=>'PATCH']) !!}
        <div class="container product">
            ...
            <div class="label-input">
                ...
                <p>
                    {!! Form::radio('status', 1 ,old('status'), ['class' => 'pull-right']) !!} <span
