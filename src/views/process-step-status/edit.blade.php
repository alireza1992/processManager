...
@section('title','ویرایش وضعیت مراحل فرایند')
...
@section(config('process-manager.views.content'))
    <div class="container product">
        ...
        {!! Form::model($process_step_status,['route'=>['admin.process-managers.process-step-status.update',$process_step_status->id],'method'=>'PATCH']) !!}
        <div class="container product">
